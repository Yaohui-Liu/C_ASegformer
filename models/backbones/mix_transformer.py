...
class TripletAttention(nn.Module):
    ...
    def forward(self, x):
        x_out1 = self.SpatialGate(x.permute(0, 2, 1, 3).contiguous()).permute(0, 2, 1, 3).contiguous()
        x_out2 = self.SpatialGate(x.permute(0, 3, 2, 1).contiguous()).permute(0, 3, 2, 1).contiguous()
